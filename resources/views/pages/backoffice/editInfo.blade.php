...
<div class="container text-center mt-5 mb-5">
  ...
  <form method="POST" action="/update-info/{{$edit->id}}">
      @csrf
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail1" aria-describedby="texte" name="info" value="{{old("info") ? old("info") : $edit->info}}">
          </div>
